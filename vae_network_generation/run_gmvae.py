...
from codebase import utils1 as ut1
...
if args.train:
    ...
    train(model=gmvae,
          ...
          tqdm=tqdm.tqdm,
          writer=writer,
          it er_max=args.iter_max,
          iter_save=args.iter_save)
    ut1.evaluate_lower_bound(gmvae, labeled_subset, run_iwae=args.train == 2)

else:
    ut.load_model_by_name(gmvae, global_step=args.iter_max)
    ut1.evaluate_lower_bound(gmvae, labeled_subset, run_iwae=True)
